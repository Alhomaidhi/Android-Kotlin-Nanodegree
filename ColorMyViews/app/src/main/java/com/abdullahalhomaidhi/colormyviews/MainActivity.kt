package com.abdullahalhomaidhi.colormyviews
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        ...
        val clickableView: List<View> = listOf(boxOneText, boxTwoText, boxThreeText, boxFourText, boxFiveText, constraintLayout, redButton, greenButton, yellowButton)
    ...
    private fun makeColored(view: View) {
        ...
        when (view.id) {
            ...
            R.id.red_button -> boxThreeText.setBackgroundColor(getColor(R.color.my_red))
            R.id.yellow_button -> boxFourText.setBackgroundColor(getColor(R.color.my_yellow))
            R.id.green_button -> boxFiveText.setBackgroundColor(getColor(R.color.my_green))
